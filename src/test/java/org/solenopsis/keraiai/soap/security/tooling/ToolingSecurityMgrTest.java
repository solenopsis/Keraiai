...
/**
 * Tests the ToolingSecurityMgr class.
 *
 * @author Scot P. Floess
 */
@RunWith(MockitoJUnitRunner.class)
public class ToolingSecurityMgrTest {

    class BogustException extends Exception {

    }

    class ToolingSecurityMgrStub extends ToolingSecurityMgr {

        ToolingSecurityMgrStub(final Credentials creds) {
            super(creds);
        }

        @Override
        protected SforceServicePortType createPort(WebServiceTypeEnum webServiceType, final String serverUrl, Service service, Class portType, String name) {
            return soap;
        }

        @Override
        protected SforceServicePortType createSessionPort(WebServiceTypeEnum webServiceType, final String serverUrl, final Service service, final Class portType, final String name, final String sessionId) {
            return soap;
        }
    }
    ...
    ToolingSecurityMgr securityMgr;
    ...
    public void setup() throws Exception {
        ...
        securityMgr = new ToolingSecurityMgrStub(credentials);
    }
    ...
    public void test_getLoginWebServiceType() {
        Assert.assertSame("Should be the correct web service type", LoginWebServiceTypeEnum.TOOLING_LOGIN_SERVICE, securityMgr.getLoginWebServiceType());
    }
    ...
    public void test_getSession() throws Exception {
        final ToolingLoginContext loginContext1 = (ToolingLoginContext) securityMgr.getSession();
    ...
    public void test_login() throws Exception {
        final ToolingLoginContext loginContext = (ToolingLoginContext) securityMgr.login();
