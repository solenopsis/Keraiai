...
/**
 * Tests the EnterpriseLoginContext class.
 *
 * @author Scot P. Floess
 */
@RunWith(MockitoJUnitRunner.class)
public class EnterpriseLoginContextTest {
    ...
    public void test_constructor_null_LoginResult() {
        new EnterpriseLoginContext(null, credentials);
    }
    ...
    public void test_constructor_null_Credentials() {
        new EnterpriseLoginContext(loginResult, null);
    }
    ...
    public void test_constructor() {
        final String serverUrl = TestUtils.generateUniqueStr("http://serverUrl.com/alpha/beta/");
