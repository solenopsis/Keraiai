...
/**
 * Tests the ToolingLoginContext class.
 *
 * @author Scot P. Floess
 */
@RunWith(MockitoJUnitRunner.class)
public class ToolingLoginContextTest {
    ...
    public void test_constructor_null_LoginResult() {
        new ToolingLoginContext(null, credentials);
    }
    ...
    public void test_constructor_null_Credentials() {
        new ToolingLoginContext(loginResult, null);
    }
